---
author: 游钓四方
pubDatetime: 2025-03-12T03:26:00+08:00
...
tags:
  ...
  - Go
cover: golang.jpg_50
description: 之前我写过一篇“利用Go+Github Actions写个定时RSS爬虫”来实现这一目...
---
之前我写过一篇[《利用Go+Github Actions写个定时RSS爬虫》](https://lhasa.icu/GrabLatestRSS.html)来实现这一目，主要是用 GitHub Actions + Go 进行持续的 RSS 拉取，再把结果上传到 GitHub Pages 站点
