---
author: 游钓四方
pubDatetime: 2025-11-25T04:09:00+08:00
...
tags:
  ...
  - 开源
  - Astro
cover: astro-logo.svg
description: Astro Lhasa 是一款简洁、响应式、无障碍友好、并具备良好 SEO 的 Astro 博客主题...
---
...
![ ](astro-lhasa-lighthouse-score.svg)
...
Markdown/MDX 扩展 - `remark-math`、`rehype-katex`、`rehype-figure`、`rehype-slug`、`rehype-autolink-headings`、`rehype-external-links`、`rehype-wrap-all`
